...
return html})}})},createControl:function(n,cm){return null},getInfo:function(){return{longname:'Clear Floats Button',author:'Graffino',authorurl:'http://graffino.com',infourl:'https://wordpress.org/plugins/clear-floats-button/',version:"1.2.4"}}});tinymce.PluginManager.add('clear',tinymce.plugins.Clear)})()