...
return html;});}});},createControl:function(n,cm){return null;},getInfo:function(){return{longname:'Clear Floats Button',author:'Graffino',authorurl:'http://graffino.com',infourl:'https://wordpress.org/plugins/clear-floats-button/',version:"1.1.0"};}});tinymce.PluginManager.add('clear',tinymce.plugins.Clear);})();