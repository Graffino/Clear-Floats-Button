...
function clear_floats_addbutton() {
    ...
    // Enqueue needed CSS
    wp_register_style('clear_floats_addbutton', plugins_url('/mce/clear/css/clearfix.css', __FILE__), false, '1.0.5', 'all');
...
function clear_floats_before_init( $options ) {
    ...
    if ( ! isset( $options['extended_valid_elements'] ) ) {
       ...
       $options['custom_elements']         .= 'div[clear|class|id|style|title|role]';
    return $options;
}
